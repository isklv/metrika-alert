...
```bash
docker compose logs --tail 1 metrika-alert | head -1
# 2026-09-14 22:08:34 metrika-alert 43759de-test
```

Ту же строку показывает команда бота `/version`. Если команда из документации
